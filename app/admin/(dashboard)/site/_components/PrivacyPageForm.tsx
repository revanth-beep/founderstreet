...
export default function PrivacyPageForm({ initial }: { initial: LegalPageCms }) {
  ...
  async function onSave(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      await patchSite({ privacyPage: page });
      setMsg("Saved.");
    } catch (ex) {
  ...
  return (
    <form onSubmit={onSave}>
      <h1 className="admin-page-title">Privacy Policy page</h1>
      <p className="admin-page-desc">
        Edit the content of the /privacy page. Each section has an optional heading and a body paragraph. Leave a heading blank to render the paragraph without a heading (useful for the intro).
      </p>

      <div className="admin-card">
        <p className="admin-card__title">Page details</p>
        <div className="admin-field">
          <label className="admin-label" htmlFor="pp-updated">Last updated date</label>
