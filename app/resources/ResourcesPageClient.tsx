...
export default function ResourcesPageClient({ posts: allPosts, copy }: Props) {
  ...
  return (
    <>
      ...
      <section style={{
        position: "relative",
        backgroundImage: "linear-gradient(90deg, rgba(15,28,20,0.95) 0%, rgba(15,28,20,0.78) 38%, rgba(15,28,20,0.28) 66%, rgba(15,28,20,0) 100%), url('/visuals/resources-hero.jpg')",
