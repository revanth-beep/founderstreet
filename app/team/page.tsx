...
export default async function TeamPage() {
  ...
  return (
    <>
      ...
      <section style={{
        position: "relative",
        backgroundImage: "linear-gradient(90deg, rgba(15,28,20,0.95) 0%, rgba(15,28,20,0.78) 38%, rgba(15,28,20,0.28) 66%, rgba(15,28,20,0) 100%), url('/visuals/team-hero.jpg')",
      ...
      <section style={{
        position: "relative",
        backgroundImage: "linear-gradient(90deg, rgba(15,28,20,0.95) 0%, rgba(15,28,20,0.78) 38%, rgba(15,28,20,0.28) 66%, rgba(15,28,20,0) 100%), url('/visuals/team-workspace.jpg')",
        backgroundSize: "100% 100%, contain", backgroundRepeat: "no-repeat, no-repeat", backgroundPosition: "center, center right", backgroundColor: "#0f1c14",
        padding: "6rem 0",
      }}>
        <div className="container-custom">
