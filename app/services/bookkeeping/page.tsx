...
import { BookOpen, ArrowRight, Receipt, FileText, PieChart } from "lucide-react";
...
export default async function BookkeepingPage() {
  const site = await getSiteContent();
  const cms = site.servicePages.bookkeeping;
        ...
        <div className="container-custom">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 300px), 1fr))", gap: "1.5rem" }}>
            {serviceCards.map((service) => {
              const Icon = SERVICE_ICON_MAP[service.iconName] ?? BookOpen;
              return (
      ...
      <section style={{ background: "#F0F0ED", paddingBlock: "clamp(4rem, 8vw, 6rem)" }}>
        <div className="container-custom">
          <div style={{ textAlign: "center", maxWidth: "36rem", margin: "0 auto 3rem" }}>
            ...
            <h2 style={{ ...h2, marginTop: "1rem" }}>Clean books, filed returns. Choose your plan.</h2>
          </div>
