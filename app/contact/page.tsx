...
export default async function ContactPage() {
  ...
  return (
    <>
      ...
      <section style={{
        position: "relative",
        backgroundImage: "linear-gradient(90deg, rgba(16,28,21,0.96) 0%, rgba(16,28,21,0.9) 35%, rgba(16,28,21,0.55) 65%, rgba(16,28,21,0.2) 100%), url('/visuals/contact-hero.jpg')",
