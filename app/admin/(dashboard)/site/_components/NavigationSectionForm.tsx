    ...
    <form onSubmit={onSave}>
      ...
      <div className="admin-card">
        ...
        <div className="admin-field">
          <label className="admin-label" htmlFor="brandName">
          ...
          <input
            ...
            value={nav.brandName}
            onChange={(e) => setNav({ ...nav, brandName: e.target.value })}
          />
        </div>
        <div className="admin-field">
          ...
          <p className="admin-hint">A few words next to the main contact button.</p>
          <input
            id="healthCtaShort"
            className="admin-input"
            value={nav.healthCtaShort}
            onChange={(e) => setNav({ ...nav, healthCtaShort: e.target.value })}
          />
        </div>
      </div>
      ...
      <div className="admin-card">
        ...
        <div className="admin-field">
          <label className="admin-label" htmlFor="healthPromoTitle">
            Promo title
          </label>
          <input
            id="healthPromoTitle"
            className="admin-input"
            value={nav.healthPromoTitle}
            onChange={(e) => setNav({ ...nav, healthPromoTitle: e.target.value })}
          />
        </div>
        <div className="admin-field">
          <label className="admin-label" htmlFor="healthPromoSubtitle">
            Promo description
          </label>
          <textarea
            id="healthPromoSubtitle"
            className="admin-textarea"
            rows={2}
            value={nav.healthPromoSubtitle}
            onChange={(e) => setNav({ ...nav, healthPromoSubtitle: e.target.value })}
          />
        </div>
      </div>
