...
import type { HireTalentPerkCms } from "@/lib/site-content-defaults";
import { patchSite } from "./patchClient";

export default function HireTalentPerkForm({ initial }: { initial: HireTalentPerkCms }) {
  ...
  async function onSave(e: React.FormEvent) {
    ...
    try {
      await patchSite({ home: { hireTalentPerk: data } });
  ...
  return (
    <form onSubmit={onSave}>
      <h1 className="admin-page-title">Home — Hire Talent Perk</h1>
      <p className="admin-page-desc">Edit the hire talent banner displayed after the Why section, next to the co-working perk.</p>
